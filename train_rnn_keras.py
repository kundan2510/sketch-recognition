...
if __name__ == '__main__':
	...
	model =  Sequential()
	# model.add(SimpleRNN(100, input_shape=(5, 512), activation='relu', return_sequences=True))
	# model.add(Dropout(0.5))
	model.add(SimpleRNN(250, input_shape=(5, 512),activation='tanh'))
	# model.add(Dropout(0.5))
	...
	model.fit(X_train,Y_train, batch_size=200, nb_epoch=2000, verbose=1, validation_data=(X_test,Y_test))