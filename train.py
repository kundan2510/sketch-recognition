...
def write_to_file(strng, fname="results_hp_x.txt"):
	f = open(fname,'ab')
	f.write(strng+"\n")
	f.close()
...
if __name__ == '__main__':
	...
	model = train_model_with_parallel_loading(model,q_train, X_test, Y_test, batch_size = 32, num_epoch=1000, samples_train_count=samples_train_count, samples_test_count=samples_test_count, datagen=None, test_data_gen=None)
