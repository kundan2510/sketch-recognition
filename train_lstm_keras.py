...
if __name__ == '__main__':
	...
	model =  Sequential()
	model.add(LSTM(512, input_shape=(5, 512), dropout_U=0.5, return_sequences=True))
	...
	model.fit(X_train,Y_train, batch_size=16, nb_epoch=2000, verbose=2, validation_data=(X_test,Y_test), callbacks=[model_check_pointing,rmm])